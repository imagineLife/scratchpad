...
const FlexLayout = () => {
	return(
		<main id="flex-layout" className="layout">
			<div id="title-box" className="f-w i-b">
			...
			<div id="area-box" className="i-b">
				<p>Area Box</p>
			</div>
			<div id="focus-area-box" className="i-b">
			...
			<div id="area-explain-box" className="i-b">
			...
			<div id="theme-box" className="i-b">
				<h2 className="section-text">Textual Themes</h2>
				<p className="explanatory-text">Colors match text to a 'theme'. CLICK</p>
				<p>Theme Box</p>
			</div>
			<div id="image-box" className="i-b">
				<p>Image Box</p>
				<h2 className="image-subtext">The President <br /> Addresses The Nation</h2>
			</div>
			<div id="words-of-interest-box" className="i-b">
